...
- **Deployed 2026-09-25** by the operator with the `SESSION_HANDOFF.md` runbook (`main` = `1d04635`). Their output matched every "Expect" line. Independent read-only verification (V1–V7) and the live test table are in `SESSION_HANDOFF.md`, for Cursor on the VPS.
